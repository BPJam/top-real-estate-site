        ...
        <Box component={'section'} sx={{ width: '100%', height: 'calc(100vh + 8rem)', backgroundColor: 'black', zIndex: 0, position: 'relative' }}>
            ...
            <Box component={'section'} sx={{ display: 'flex', flexDirection: 'row', zIndex: 2, position: 'absolute', top: '6rem', bottom: '6rem', left: '6rem', right: '6rem' }}>
                <Box component={'section'} sx={{ width: '50%',  padding: '0 2rem' }}>
                    <Box component={'section'} sx={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', borderRadius: '0.3rem' }}>
                        <Box component={'section'} sx={{ height: '30%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                            <Typography component={'h1'} sx={{ textAlign: 'center', fontSize: '1.8rem', fontWeight: 600, color: 'whitesmoke', margin: '1rem 0' }}>
                                Зв'яжіться з нами
                            </Typography>

                            <Typography component={'p'} sx={{ fontSize: '1rem', textAlign: 'center', pl: '15%', pr: '15%', fontWeight: 500, color: 'whitesmoke' }}>
                        ...
                        <Box component={'section'} sx={{ height: '70%',  display: 'flex', flexDirection: 'column' }}>
                            <Box component={'section'} sx={{ height: '50%', display: 'flex', flexDirection: 'row' }}>
                                <Box component={'section'} sx={{ height: '100%', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <Link target='_blank' href='https://api.whatsapp.com/send?phone=380937525497' sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '10rem', width: '10rem', '&:hover': { backgroundColor: 'rgba(0,0,0,0.3)', borderRadius: '0.3rem' }, textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
                                        <WhatsApp />
                                    
                                        <Typography component={'p'} sx={{ cursor: 'pointer', color: 'whitesmoke' }}>
                                            WhatsApp
                                        </Typography>
                                    </Link>
                                </Box>
                                ...
                                <Box component={'section'} sx={{ height: '100%', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <Link target='_blank' href='https://t.me/Viktoria_BayrakTB' sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '10rem', width: '10rem', '&:hover': { backgroundColor: 'rgba(0,0,0,0.3)', borderRadius: '0.3rem' }, textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
                                        <Telegram />
                            ...
                            <Box component={'section'} sx={{ height: '50%', display: 'flex', flexDirection: 'row' }}>
                                <Box component={'section'} sx={{ height: '100%', width: '100%', display: 'flex', justifyContent: 'center' }}>
                                    <Link target='_top' href='tel:+380978357007' sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '10rem', width: '10rem', '&:hover': { backgroundColor: 'rgba(0,0,0,0.3)', borderRadius: '0.3rem' }, textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
                                        <Kyivstar />
                                ...
                                <Box component={'section'} sx={{ height: '100%', width: '100%', display: 'flex', justifyContent: 'center' }}>
                                    <Link target='_top' href='tel:+380937525497' sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '10rem', width: '10rem', '&:hover': { backgroundColor: 'rgba(0,0,0,0.3)', borderRadius: '0.3rem' }, textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
                                        <Lifecell />
